...
@NamedQueries({
    ...
    @NamedQuery(name = "Cliente.findByApellidonombre", query = "SELECT c FROM Cliente c WHERE c.apellidonombre = :apellidonombre"),
...
public class Cliente implements Serializable {
    ...
    public Cliente(Integer id, Character estado) {
        this.id = id;
        this.estado = estado;
    }
